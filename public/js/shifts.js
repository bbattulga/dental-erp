...
$(document).ready(function () {
  ...
  //WEATHER LOCATION
  $(".fc-month-button.fc-button.fc-state-default.fc-corner-left.fc-state-active").text("Сар")
  $(".fc-agendaWeek-button.fc-button.fc-state-default").text("Энэ долоо хоног")
  $(".fc-agendaDay-button.fc-button.fc-state-default").text("Өдөр")
  $(".fc-listWeek-button.fc-button.fc-state-default.fc-corner-right").text("Жагсаалт")
  $(".fc-today-button.fc-button.fc-state-default.fc-corner-left.fc-corner-right").text("өнөөдөр")
  $(".fc-center h2").text("4-р Сар 2018");
  $(".fc-prev-button").click(() => {
    let data = $(".fc-center h2").text();
    

    switch(data.split(' ')[0]){
      case "January":
        $(".fc-center h2").text("1-р Сар " + data.split(' ')[1]);
        break;
      case "February":
        $(".fc-center h2").text("2-р Сар " + data.split(' ')[1]);
        break;
      case "March":
        $(".fc-center h2").text("3-р Сар " + data.split(' ')[1]);
        break;
      case "April":
        $(".fc-center h2").text("4-р Сар " + data.split(' ')[1]);
        break;
      case "May":
        $(".fc-center h2").text("5-р Сар " + data.split(' ')[1]);
        break;
      case "June":
        $(".fc-center h2").text("6-р Сар " + data.split(' ')[1]);
        break;
      case "July":
        $(".fc-center h2").text("7-р Сар " + data.split(' ')[1]);
        break;  
      case "August":
        $(".fc-center h2").text("8-р Сар " + data.split(' ')[1]);
        break;          
      case "September":
        $(".fc-center h2").text("9-р Сар " + data.split(' ')[1]);
        break;      
      case "October":
        $(".fc-center h2").text("10-р Сар " + data.split(' ')[1]);
        break;    
      case "November":
        $(".fc-center h2").text("11-р Сар " + data.split(' ')[1]);
        break;                
      case "December":
        $(".fc-center h2").text("12-р Сар " + data.split(' ')[1]);
        break;
    }
  });
