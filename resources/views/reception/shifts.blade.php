                        ...
                        @foreach($doctors as $doctor)
                            ...
                            <tr>
                                ...
                                @for($i = 0; $i < 30; $i++)
                                    ...
                                    @elseif($time = $shifts->where('date', date('Y-m-d', strtotime('+' . $i . ' Days')))->where('doctor_id', $doctor->staff->id)->where('shift_id', 3)->first())
                                        <td rowspan="2">
                            ...
                            <tr>
                                @for($i = 0; $i < 30; $i++)
                                    <?php $time = $shifts->where('date', date('Y-m-d', strtotime('+' . $i . ' Days')))->where('doctor_id', $doctor->staff->id)->where('shift_id', 2)->first(); ?>
                                    @if($time)
                                        <td>
